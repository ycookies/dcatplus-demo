...
class CashVerifyForm extends Form implements LazyRenderable {
    ...
    public function handle(array $input) {
        ...
        $updata = [
            ...
            'content' => $request->get('verify_msg', ''),
            'updated_at' => Carbon::now(),
        ];
        // 更新审核信息
        ShareCash::whereIn('id', explode(',', $input['id']))->update($updata);
    ...
    public function form() {
        ...
        $this->select('status', '审核状态')->options(ShareCash::Verify_status_arr)->required();
        // 密码确认表单
